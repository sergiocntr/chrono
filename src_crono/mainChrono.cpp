...
void getLocalTemp(){
    ...
    if(dht.getStatus()!= dht.ERROR_NONE)  {
      String err = "DHT errore: " + String(dht.getStatus());
      mqttOK = client.publish(logTopic,err.c_str());
    }else
    {
      ...
      delay(10);
      root["topic"]="SalChr";
      root["hum"] = ((int)(tH.humidity * 100 + .5) / 100.0);
      root["temp"] = ((int)(tH.temperature * 100 + .5) / 100.0);
      smartDelay(100);
